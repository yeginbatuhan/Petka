...
{{--                <input class="form-control input" type="text" placeholder="Keşfedin..." tabindex="0" data-search="template-search">--}}
...
{{--                <i class="flag-icon flag-icon-tr mr-50"></i> Türkçe--}}
{{--              </a>--}}
...
{{--          bx-tada   bu i tagına eklenince zil hareket eder--}}
{{--          <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon bx bx-bell  bx-flip-horizontal"></i><span class="badge badge-pill badge-danger badge-up">0</span></a>--}}
...
{{--                <span class="user-status text-muted">Available</span>--}}
              ...
              <span><img class="round" src="{{asset('images/petka/user/userimage.png')}}" alt="avatar" height="40" width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
{{--              <a class="dropdown-item" href="{{asset('page/user/profile')}}">--}}
{{--                <i class="bx bx-user mr-50"></i> Profili Düzenle--}}
{{--              </a>--}}
...
{{--              </a>--}}
              ...
              <a class="dropdown-item" href="{{route('logout')}}"><i class="bx bx-power-off mr-50"></i> Çıkış Yap</a>
            </div>
          </li>
        </ul>
      </div>
