...
{{-- page Title --}}
@section('title','İzin Güncelleme Ekranı')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('permit_update',$permitedit->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">İzin Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">İzin Adı</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="permit_name"
                     value="{{$permitedit->permit_name}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">İzin Yılı</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="permit_year"
                     value="{{$permitedit->permit_year}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Toplam İzin</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="permit_total_days"
                     value="{{$permitedit->permit_total_days}}" required/>
            </div>
          </div>
