            ...
            <div class="col-12">
                <div class="card faq-bg bg-transparent box-shadow-0 p-1 p-md-5">
                    <div class="card-body p-0">
                        <h1 class="faq-title text-center mb-3">Merhaba, yönetim paneline hoş geldiniz </h1>
               {{--         <form>
                            <fieldset class="faq-search-width form-group position-relative w-50 mx-auto">
                                ...
                                <button class="btn btn-primary round position-absolute d-block d-sm-none" type="button">
                                    <i
    ...
    <section class="faq-bottom" style="margin-top: -60px;">
        <div class="row mb-2">
            <div class="col-12 text-center">
                <h2 class="faq-subtitle">Uygulama Linki</h2>
                <a href="itms-services://?action=download-manifest&url=https://petka.xayyazilim.com/public/petka/manifest.plist">
                    <img src="{{asset('public/petka/apple.png')}}"
                         width=100"><br>
                  Petka Mobil Iphone uygulamasını indirmek için logoya tıklayınız.
                </a>
                <p class="p-2 text-muted font-medium-1">Bize aşağı yer alan iletişim bilgilerini kullanarak
                    ulaşabilirsiniz.</p>
            </div>
        </div>
