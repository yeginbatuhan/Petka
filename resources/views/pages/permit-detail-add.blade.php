...
{{-- page Title --}}
@section('title','İzin Detayı Manuel Ekleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('permit_detail_store')}}" method="POST">
      @csrf

      <input type="hidden" name="permit_id" value="{{$prmtid}}" required>

      <div class="card mb-4">
        <h5 class="card-header">İzin Detayı Manuel Ekleme</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Başlangıç Tarihi</label>
            <div class="col-md-10">
              <input class="form-control" type="date" id="html5-text-input" name="permit_detail_start_date"  required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Bitiş Tarihi</label>
            <div class="col-md-10">
              <input class="form-control" type="date" id="html5-text-input" name="permit_detail_end_date" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Kullanılan Gün</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="permit_detail_use_day" required/>
            </div>
          </div>
        </div>
