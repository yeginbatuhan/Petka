...
{{-- page Title --}}
@section('title','Petka Stok Detay Manuel Ekleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('ptkstock_detail_store')}}" method="POST">
      @csrf

        <input type="hidden" name="petka_stock_id" value="{{$stockid}}" required>

      <div class="card mb-4">
        <h5 class="card-header">Petka Stok Detay Manuel Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_detail_code"  required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Adı TR</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_detail_name_tr"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Adı EN</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_detail_name_en" />
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Miktar</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_detail_quantity" required/>
            </div>
          </div>
