...
{{-- page Title --}}
@section('title','Proje Detay Excel Ekleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <br>
    <br>
    <a href="{{route('order_detail_excel_download')}}" target="_blank"><h5>Örnek Excel Dosyasını İndirmek İçin Buraya Tıklayınız</h5></a>
    <form action="{{route('order_detail_import')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Proje Detay Excel Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Detay Excel</label>
            <div class="col-md-10">
              <input class="form-control" type="file" id="html5-text-input" name="excel_file" required/>
            </div>
            @error('excel_file')
        ...
        <button type="submit" class="btn btn-success" style="color:#000000 ;font-family:arial;"><b>Yükle</b></button>
      </div>
      </div>
