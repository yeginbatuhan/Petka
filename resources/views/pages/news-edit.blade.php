...
{{-- page Title --}}
@section('title','Müşteri Bülten Güncelleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <br>
    <br>
    <form action="{{route('new_update',$newsedit->id)}}" method="POST" enctype="multipart/form-data">
      @csrf
      <input type="hidden" name="old_image" value="{{$newsedit->new_image}}" >
      <div class="card mb-4">
        <h5 class="card-header">Müşteri Bülten Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Bülten Başlığı</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="new_title" value="{{$newsedit->new_title}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Bülten Görseli</label>
            <div class="col-md-10">
              <input class="form-control" type="file" id="html5-text-input" name="new_image" required/>
              <span>Var olan Görsel:{{$newsedit->new_image}}</span>
            </div>
            @error('new_image')
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              ...
              <textarea name="new_text" id="bulletin_text">{{$newsedit->new_text}}</textarea>
            </div>
            @error('new_text')
