    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form repeater-default" action="{{route('offer_store')}}" method="POST">
              @csrf
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  id="defaultFormControlInput"
                  aria-describedby="defaultFormControlHelp"
                  name="offer_project_name_en"

                />
              </div>
              <div>
                <label for="defaultFormControlInput" class="form-label">Proje Teklif Tarihi Girin</label>
                <input type="date" class="form-control" id="Name" name="offer_date" required>
              </div>
              <h4 class="card-title mt-3">Teklif Detayları</h4>
              <hr>
                ...
                <div data-repeater-item>
                  ...
                  <div class="row justify-content-between">
                    <div class="col-md-2 col-sm-12 form-group">
                      ...
                      <input type="text" class="form-control" id="Name" name="offer_detail_code" required>
                    </div>
                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Ürün Adı TR </label>
                      <input type="text" class="form-control" id="Name" name="offer_detail_name_tr">
                    </div>
                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Ürün Adı EN </label>
                      <input type="text" class="form-control" id="Name" name="offer_detail_name_en">
                    </div>

                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Miktar </label>
                      <input type="text" class="form-control" id="Name" name="offer_detail_quantity" required>
                    </div>
{{--                    <div class="col-md-2 col-sm-12 form-group">--}}
...
{{--                    </div>--}}
                    <div class="col-md-2 col-sm-12 form-group">
                      ...
                      <input type="text" class="form-control" id="Name" name="offer_detail_unit_price" required>
                    </div>
