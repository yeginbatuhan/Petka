...
{{-- page Title --}}
@section('title','Teklif Güncelleme Ekranı')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('offer_update',$offeredit->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Teklif Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_project_code" value="{{$offeredit->offer_project_code}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı TR</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name ="offer_project_name_tr" value="{{$offeredit->offer_project_name_tr}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı EN</label>
            <div class ="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_project_name_en" value="{{$offeredit->offer_project_name_en}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Teklif Tarihi Girin</label>
            <div class="col-md-10">
              <input type="date" class="form-control" id="html5-text-input" name="offer_date" value="{{$offeredit->offer_date}}" required>
            </div>
          </div>
        </div>
