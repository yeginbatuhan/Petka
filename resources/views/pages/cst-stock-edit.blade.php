...
{{-- page Title --}}
@section('title','Müşteri Numunesi Düzenleme Ekranı')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('cst_stock_update',$cst->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Müşteri Numunesi Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="customer_stock_code" value="{{$cst->customer_stock_code}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı TR</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name ="customer_stock_name_tr" value="{{$cst->customer_stock_name_tr}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı EN</label>
            <div class ="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="customer_stock_name_en" value="{{$cst->customer_stock_name_en}}"/>
            </div>
          </div>
