...
{{-- page Title --}}
@section('title','Proje Excel Ekleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <br>
    <br>
    <a href="{{route('order_excel_download')}}" target="_blank"><h5>Örnek Excel Dosyasını İndirmek İçin Buraya Tıklayınız</h5></a>
    <form action="{{route('order_import')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Proje Excel Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Excel</label>
            <div class="col-md-10">
