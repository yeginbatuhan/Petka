      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">
             Müşteri Numunesi Ekleme Alanı
            </h4>
          </div>
          <div class="card-body">
            <form class="form repeater-default" action="{{route('cst_stock_store')}}" method="POST">
              @csrf
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  id="defaultFormControlInput"
                  aria-describedby="defaultFormControlHelp"
                  name="customer_stock_name_en"

                />
              </div>
              <h4 class="card-title mt-3">Numune Detayları</h4>
              <hr>
                ...
                <div data-repeater-item>
                  ...
                  <div class="row justify-content-between">
                    <div class="col-md-2 col-sm-12 form-group">
                      ...
                      <input type="text" class="form-control" id="Name" name="customer_stock_detail_name_tr" >
                    </div>
                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Ürün Adı EN </label>
                      <input type="text" class="form-control" id="Name" name="customer_stock_detail_name_en">
                    </div>

                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Miktar </label>
                      <input type="text" class="form-control" id="Name" name="customer_stock_detail_quantity" required>
                    </div>
                    <div class="col-md-2 col-sm-12 form-group">
                      <label for="Email">Birim </label>
                      <select id="order_detail_unit" class="select3 form-control" name="customer_stock_detail_unit" >
                      ...
                      @error('customer_stock_detail_unit')
