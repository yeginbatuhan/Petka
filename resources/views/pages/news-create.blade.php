...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <br>
    <br>
    <form action="{{route('new_store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Müşteri Bülten Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Müşteri Seçiniz</label>
            <div class="col-md-10">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="new_title" required/>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              <textarea name="new_text" id="bulletin_text"></textarea>
            </div>
          </div>
