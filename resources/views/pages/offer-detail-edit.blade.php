...
{{-- page Title --}}
@section('title','Teklif Proje Detay Güncelleme')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('offer_detail_update',$detailedit->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Teklif Proje Detay Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_detail_code" value="{{$detailedit->offer_detail_code}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Adı TR</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_detail_name_tr" value="{{$detailedit->offer_detail_name_tr}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ürün Adı EN</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_detail_name_en" value="{{$detailedit->offer_detail_name_en}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Miktar</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_detail_quantity" value="{{$detailedit->offer_detail_quantity}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Birim Fiyat</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="offer_detail_unit_price" value="{{$detailedit->offer_detail_unit_price}}" required/>
            </div>
          </div>
