...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('user_update',$user->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Müşteri - Personel Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Kullanıcı Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="user_code"
                     value="{{$user->user_code}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Ad Soyad</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="name" value="{{$user->name}}"
                     required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="smallSelect" class="col-form-label col-md-2">Kullanıcı Tipi</label>
            <div class="col-md-10">
          ...
          <div class="row mb-3">
            <label for="html5-email-input" class="col-form-label col-md-2">Mail</label>
            <div class="col-md-10">
              <input class="form-control" type="email" id="html5-email-input" name="email" value="{{$user->email}}"
                     required/>
            </div>
          </div>
          ...
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Telefon Numarası</label>
            <div class="col-md-10">
              <input class="form-control" type="number" id="html5-text-input" name="phone_number"
