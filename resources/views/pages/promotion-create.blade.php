...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('promotion_store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Tanıtım Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Tanıtım Başlığı</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="promotion_title" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Tanıtım PDF Yükleme</label>
            <div class="col-md-10">
              <input class="form-control" type="file" id="html5-text-input" name="promotion_pdf" required/>
            </div>
            @error('promotion_pdf')
