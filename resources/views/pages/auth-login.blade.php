...
{{-- page title --}}
@section('title','Petka Kalıp Mobil Uygulama  | Giriş')
{{-- page scripts --}}
@section('page-styles')
          ...
          <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
            <div class="card-header pb-1">
              <div class="card-title">
                <h4 class="text-center mb-2">Petka Kalıp Mobil Uygulama Yönetim Paneline Hoş Geldiniz</h4>
              </div>
            </div>
            <div class="card-body">
              ...
              <form action="{{route('login')}}" method="post">
                @csrf
                  <div class="form-group mb-50">
                      <label class="text-capitalize text-bold-600" for="exampleInputEmail1">Email Adresiniz</label>
                      <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                          placeholder="Email Adresiniz"></div>
                  <div class="form-group">
                      <label class="text-capitalize text-bold-600" for="exampleInputPassword1">Şifreniz</label>
...
{{--                              class="card-link"><small>Forgot Password?</small></a></div>--}}
                  ...
                  <button type="submit" class="btn glow w-100 position-relative" style="background-color: #c52128; color: white;">Giriş Yap<i
