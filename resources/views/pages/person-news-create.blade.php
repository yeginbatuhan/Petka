...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <br>
    <br>
    <form action="{{route('person_new_store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Personel Bülten Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Personel Seçiniz</label>
            <div class="col-md-10">
              <select class="select2 form-control" name="user_id" id="select_box" required>
                <option  disabled selected>Personel Seçiniz</option>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="person_new_title" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Bülten Görseli</label>
            <div class="col-md-10">
              <input class="form-control" type="file" id="html5-text-input" name="person_new_image" required/>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              <textarea name="person_new_text" id="bulletin_text"></textarea>
            </div>
            @error('person_new_text')
