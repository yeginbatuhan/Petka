...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('user_store')}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Müşteri - Personel Ekleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Kullanıcı Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="user_code" value="{{old('user_code')}}" required/>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-10">
              <input class="form-control" type="number"  id="html5-text-input" name="phone_number" required />
            </div>
          </div>
