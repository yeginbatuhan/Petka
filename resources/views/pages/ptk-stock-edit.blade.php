...
{{-- page Title --}}
@section('title','Petka Stok Düzenleme Ekranı')
{{-- vendor css --}}
...
@section('content')
  ...
  <section class="faq-bottom" style="margin-top: -60px;">
    ...
    <form action="{{route('ptk_stock_update',$ptk->id)}}" method="POST">
      @csrf
      <div class="card mb-4">
        <h5 class="card-header">Petka Stok Güncelleme Alanı</h5>
        <div class="card-body">
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Kodu</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_code" value="{{$ptk->petka_stock_code}}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı TR</label>
            <div class="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name ="petka_stock_name_tr" value="{{$ptk->petka_stock_name_tr}}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label for="html5-text-input" class="col-form-label col-md-2">Proje Adı EN</label>
            <div class ="col-md-10">
              <input class="form-control" type="text" id="html5-text-input" name="petka_stock_name_en" value="{{$ptk->petka_stock_name_en}}"/>
            </div>
          </div>
